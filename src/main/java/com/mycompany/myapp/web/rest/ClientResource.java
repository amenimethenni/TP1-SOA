...
public class ClientResource {
    ...
    public List<ClientDTO> getAllClients(@RequestParam(required = false) String filter) {
        if ("loyaltycard-is-null".equals(filter)) {
            log.debug("REST request to get all Clients where loyaltyCard is null");
            return clientService.findAllWhereLoyaltyCardIsNull();
        }
